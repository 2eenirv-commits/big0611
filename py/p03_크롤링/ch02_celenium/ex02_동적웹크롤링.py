...
# C:\이훈경\git\big0611\py\p03_크롤링\ch02_celenium

# 셀레니움 3.x 이전
# 드라이버에 속한 경로에 한글명이 없어야 한다.
#driver = webdriver.Chrome("C:\\이훈경\\git\\big0611\\py\\p03_크롤링\\ch02_celenium\\chromedriver.exe")
# 역슬래시는 \\두번 써야함
# driver = webdriver.Chrome("C:/이훈경/git/big0611/py/p03_크롤링/ch02_celenium/chromedriver.exe")
...
# service = Service("C:\\이훈경\\git\\big0611\\py\\p03_크롤링\\ch02_celenium\\chromedriver.exe")
